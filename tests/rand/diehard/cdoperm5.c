...
// use original "operm5.cov" rather than the C-version
//#define USE_OPERM5_COV

#ifndef USE_OPERM5_COV
#include "operm5.h"
#endif
...
void operm5(char *filename)
{
  ...
  puts("\t|derings of five numbers.  Thus the 5th, 6th, 7th,...numbers  |");
  puts("\t|each provide a state. As many thousands of state transitions |");
